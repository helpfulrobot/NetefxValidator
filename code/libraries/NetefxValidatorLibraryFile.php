...
class NetefxValidatorLibraryFile
{
    ...
    // ************************ Often used functions for validation **********************
         ...
         */
        public static function check_mime_types($data, $args)
        {
            $field = $args["field"];
            $arr_file = $data[$field];
         ...
         */
        public static function check_file_exists($data, $args)
        {
            $field = $args["field"];
            $arr_file = $data[$field];
        ...
        */
        ...
        public static function check_file_size($data, $args)
        {
            $field = $args["field"];
            $arr_file = $data[$field];
        ...
        */
        ...
        public static function check_image_size($data, $args)
        {
            $field = $args["field"];
            $arr_file = $data[$field];
